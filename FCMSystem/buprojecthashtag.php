                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>&nbsp;</div>
                            <div>
                                &nbsp;&nbsp;<a href="buprojecthashtagadd.php" class="btn btn- bg-gradient-primary"><i class="fas fa-hashtag"></i> Add Hashtag</a>
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href='./buprojecthashtagview.php?viewhashtag=<?php echo $htid; ?>' name='viewproject' class="btn btn-sm bg-gradient-info"><i class="fas fa-pencil-alt"></i> View</a>&nbsp;&nbsp;&nbsp;&nbsp;

                                                            <a href='./buprojecthashtagedit.php?edithashtag=<?php echo $htid; ?>' name='editproject' class="btn btn-sm bg-gradient-success"><i class="fas fa-edit"></i> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                            
                                                            <a href='./buprojecthashtagdelete.php?deletehashtag=<?php echo $htid; ?>' name='deletehashtag' class="btn btn-sm bg-gradient-danger" onclick='return confirm("Are you sure you want to delete this item?")'><i class="fas fa-trash"></i> Delete</a>&nbsp;&nbsp;&nbsp;&nbsp;
