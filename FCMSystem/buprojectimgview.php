...
<head>
    ...
    <title>File & Content Management System | View Images Details</title>
                              ...
                              <div class='card-body'>
                                <div class='row'>
                                  ...
                                  <div class='col-md-2'>
                                    <div class='form-group'>
                                      <label>&nbsp;</label>
                                      <a href='buimgdownload.php?filename=" . $imgData['imfilename'] . "' class='btn btn-primary btn-block'><i class='fas fa-arrow-circle-down'></i> Download Image</a>
                                    </div>
                                  </div>
                                  <div class='col-md-12'>
