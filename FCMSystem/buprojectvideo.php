                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div>&nbsp;</div>
                                <div>
                                    &nbsp;&nbsp;<a href="buprojectvideoadd.php" class="btn btn- bg-gradient-primary"><i class="fas fa-file-video"></i> Add Video</a>
                                            ...
                                            ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href='./buprojectvideoview.php?viewvideo=<?php echo $viid; ?>' name='viewvideo' class='btn btn-sm bg-gradient-info'><i class='fas fa-pencil-alt'></i> View</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                                
                                                                <a href='./buprojectvideoedit.php?editvideo=<?php echo $viid; ?>' name='editvideo' class='btn btn-sm bg-gradient-success'><i class='fas fa-edit'></i> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;

                                                                <a href='./buprojectvideodelete.php?deletevideo=<?php echo $viid; ?>' name='deletevideo' class='btn btn-sm bg-gradient-danger'onclick='return confirm("Are you sure you want to delete this item?")' ><i class='fas fa-trash'></i> Delete</a>&nbsp;&nbsp;&nbsp;&nbsp;
