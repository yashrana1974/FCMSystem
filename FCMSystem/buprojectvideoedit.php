...
<head>
    ...
    <title>File & Content Management System | Edit Video Details</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-secondary">
                                ...
                                if (isset($_GET["editvideo"])) {
                                    ...
                                    $query = "SELECT * FROM res_video_db WHERE viid = '$id'";
                                    $result = mysqli_query($conn, $query);
                                    if ($result) {
                                        $userData = mysqli_fetch_array($result);
                                ?>
                                        <form id="quickForm" action="buprojectvideoeditdb.php" method="POST" enctype="multipart/form-data">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="exampleInputbuname">Video Title</label>
                                                            <input type="text" name="vititle" class="form-control" id="exampleInputbuname" placeholder="Enter Title" value="<?php echo $userData['vititle']; ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                        ...
                                                        // Check if viid is assigned to prid in res__db
                                                        $viid = $userData['viid'];
                                                        $viprid = $userData['prid'];
                          ...
                          <div class='col-md-12'>
                          <label for='exampleInputbuname'>Upload New Video</label>
                          <input type='file' class='btn btn-secondary btn' name='vicontent' id='fileToUpload' accept='video/*' capture='camera' >
                          </div>
                        </div>
                        <input type='hidden' name=oldvifilename value='" . $userData['vifilename'] . "'/>
                        <br>
                      </div>
                      <div>
                      </div>";
                                                        ...
                                                        <div style="text-align:center;">
                                                            ...
                                                            <input type="hidden" value="<?php echo $userData['viid']; ?>" name="editvideo">
                                                        </div>
                                                        <!-- /.row -->
                                        </form>
