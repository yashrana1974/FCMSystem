...
<head>
    ...
    <title>File & Content Management System | View Video Details</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="./buprojectvideo.php">
                                        <h5><u>
                                                << Back</u>
                                        </h5>
                                    </a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-secondary">
                                ...
                                if (isset($_GET["viewvideo"])) {
                                    $id = $_GET["viewvideo"];
                                    // Fetch data from the database based on the video ID
                                    $viewVideoQuery = "SELECT * FROM res_video_db WHERE viid = '$id'";
                                    $result = mysqli_query($conn, $viewVideoQuery);
                                    if ($result) {
                                        $videoData = mysqli_fetch_array($result);
                                ...
                                <div class='row'>
                                  <div class='col-md-6'>
                                    <div class='form-group'>
                                      ...
                                      <input type='text' name='vititle' class='form-control' id='exampleInputbuname' placeholder='Enter Title' value='" . $videoData['vititle'] . "' readonly>
                                    </div>
                                  </div>
                                  <div class='col-md-2'>
                                    <div class='form-group'>
                                      <label>&nbsp;</label>
                                      <a href='buvideodownload.php?filename=" . $videoData['vifilename'] . "' class='btn btn-primary btn-block'><i class='fas fa-arrow-circle-down'></i> Download Video</a>
                                    </div>
                                  </div>
                                  <div class='col-md-12'>
                                    <label>Select Project</label><br>
                                    <select class='form-control' name='viprid' readonly>";
                                        ...
                                        $viid = $videoData['viid'];
                                        $viprid = $videoData['prid'];
                                        $assignedPridQuery = "SELECT prid, prname FROM res_project_db WHERE prid = '$viprid'";
                                  ...
                                  <div class='col-md-12'>
                                  <br>
                                  <video class='video-container' controls muted autoplay loop width='400' height='300'>
                                    <source src='./Videos/" . $videoData['vifilename'] . "' type='video/mp4'>
                                    </video>
                                  </div>
                                </div><br>
                              </div>
