...
<head>
  ...
  <title>File & Content Management System | Bug Report</title>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-secondary">
                <!-- /.card-header -->
                <!-- form start -->
                <form id="quickForm" action="bureportsubmit.php" method="POST" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="exampleInputbuname">Subject</label>
                          <input type="text" name="rpsubject" class="form-control" id="exampleInputbuname" placeholder="Enter Subject" maxlength="100" required />
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="date" name="rpdate" class="form-control" id="exampleInputbuname" placeholder="Select Date" required />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <label for="exampleInputbuname">Description</label>
                        <textarea type="text" class="form-control" id="exampleInputbuname" placeholder="Describe the Bug" name="rpdescription" rows="8" maxlength="200" required /></textarea>
                      </div>
                      <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
