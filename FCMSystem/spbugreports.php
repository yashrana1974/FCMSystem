...
<head>
    ...
    <title>File & Content Management System | Bug Reports</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Bug Reports List</h1>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $query1 = "SELECT * FROM res_report_db";
                                        $data1 = mysqli_query($conn, $query1);
                                        $i = 0; // Counter for rows
                                        while ($row1 = mysqli_fetch_array($data1)) {
                                            $rpid = $row1['rpid'];
                                            $query2 = "SELECT * FROM cus_business_users WHERE buid = $row1[buid]";
                                            $data2 = mysqli_query($conn, $query2);
                                            $row2 = mysqli_fetch_array($data2);
                                            echo "<tr>
                                            <td>" . ++$i . "</td>
                                            <td>" . $row1['rpdate'] . "</td>
                                            <td>" . $row1['rpsubject'] . "</td>
                                            <td class='truncate' title='" . htmlspecialchars($row1['rpdescription']) . "'>
                                            " . substr(htmlspecialchars($row1['rpdescription']), 0, 100) . "
                                            </td>
                                            <td>" . $row2['buname'] . "</td>
                                            <td>"; ?>
                                            
                                            <a href='./spbugreportsview.php?viewbugreport=<?php echo $rpid ?>' name='viewbugreport' class='btn btn-sm bg-gradient-info'><i class='fas fa-pencil-alt'></i> View</a>&nbsp;&nbsp;&nbsp;&nbsp;

                                            <a href='./spbugreportsdelete.php?deletebugreport=<?php echo $rpid ?>' name='deletebugreport' class='btn btn-sm bg-gradient-danger' onclick='return confirm("Are you sure you want to delete this item?")'><i class='fas fa-trash'></i> Delete</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                            </td>
                                            </tr>
                                        <?php
                                        }
