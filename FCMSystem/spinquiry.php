...
<head>
    ...
    <title>File & Content Management System | Inquiries</title>
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $query1 = "SELECT * FROM res_inquiry_db";
                                        ...
                                        while ($row1 = mysqli_fetch_array($data1)) {
                                            ...
                                            <td>" . $row1['inqdate'] . "</td>
                                            <td>" . $row1['inqemail'] . "</td>
                                            <td>" . $row1['inqmobile'] . "</td>
                                            <td>" . $row1['inqsubject'] . "</td>
                                            <td class='truncate' title='" . htmlspecialchars($row1['inqmessage']) . "'>
                                            " . substr(htmlspecialchars($row1['inqmessage']), 0, 100) . "
                                            </td>
                                            <td>"; ?>
                                            <a href='./spinquiryview.php?viewinquiry=<?php echo $inqid ?>' name='viewinquiry' class='btn btn-sm bg-gradient-info'><i class='fas fa-pencil-alt'></i> View</a>&nbsp;&nbsp;&nbsp;&nbsp;

                                            <a href='./spinquirydelete.php?deleteinquiry=<?php echo $inqid ?>' name='deleteinquiry' class='btn btn-sm bg-gradient-danger' onclick='return confirm("Are you sure you want to delete this item?")'><i class='fas fa-trash'></i> Delete</a>&nbsp;&nbsp;&nbsp;&nbsp;
