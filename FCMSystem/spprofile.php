                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="./spdashboard.php">
                                        <h5><u>
                                                << Back</u>
                                        </h5>
                                    </a></li>
                  ...
                  <div class='card-body'>
                    ...
                    <input type='hidden' name='spid' value='" . $_SESSION['spid'] . "'>
                      <div class='col-md-3'>
                        ...
                        <input type='text' name='spname' class='form-control' id='exampleInputbuname' placeholder='Enter name' value='" . $_SESSION['spname'] . "' disabled>
                      </div>
                      <div class='form-group'>
                        <label for='exampleInputbuphone'>Phone Number</label>
                        <input type='tel' name='spmobileadmin' class='form-control' id='exampleInputbuphone' pattern='[0-9]{3}[0-9]{3}[0-9]{4}' placeholder='1234567890' maxlength='10' inputmode='numeric' value='" . $_SESSION['spmobileadmin'] . "' disabled>
                      </div>
                      &nbsp&nbsp&nbsp
                      <div class='form-group'>
                        <label>Change Password</label><br/>
                        <a href='./sppasswordchange.php?user=$spid' name='sppasswordadmin' class='btn btn-sm bg-gradient-primary'><i class='fas fa-lock'></i> Change</a>&nbsp;&nbsp;&nbsp;&nbsp;
                      </div>
                      &nbsp&nbsp&nbsp
                      <br/>
                    </div>
