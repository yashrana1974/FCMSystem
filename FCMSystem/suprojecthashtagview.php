...
<head>
    ...
    <title>File & Content Management System | View Hashtag Details</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-secondary">
                                ...
                                $buid = $_SESSION['suid'];
                                include("connect.php");
                                if (isset($_GET["viewhashtag"])) {
                                    $id = $_GET["viewhashtag"];
                                    // Fetch data from the database based on the user ID
                                    $viewHashtagQuery = "SELECT * FROM res_hashtag_db WHERE htid = '$id'";
                                    $result = mysqli_query($conn, $viewHashtagQuery);
                                    if ($result) {
                                ...
                                <div class='row'>
                                  <div class='col-md-6'>
                                    <div class='form-group'>
                                      ...
                                      <input type='text' name='httitle' class='form-control' id='exampleInputbuname' placeholder='Enter Title' value='" . $userData['httitle'] . "' readonly>
                                    </div>
                                  </div>
                                  <div class='col-md-12'>
                                    <label>Select Project</label><br>
                                    <select class='form-control' name='htprid' readonly>";
                                        ...
                                        // Check if htid is assigned to prid in reshashtag_db
                                        $htid = $userData['htid'];
                                  ...
                                  <br>
                                    ...
                                    <textarea type='text' class='form-control' id='exampleInputbuname' placeholder='Enter Content' name='htcontent' rows='8' readonly>" . $userData['htcontent'] . "</textarea>
                                  </div>
                                </div><br>
                              </div>
                              <div>
