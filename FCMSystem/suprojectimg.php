                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div>&nbsp;</div>
                                <div>
                                    &nbsp;&nbsp;<a href="suprojectimgadd.php" class="btn btn- bg-gradient-primary"><i class="fas fa-file-image"></i> Add Image</a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                            ...
                                            ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href='./suprojectimgview.php?viewimg=<?php echo $imid; ?>' name='viewimg' class='btn btn-sm bg-gradient-info'><i class='fas fa-pencil-alt'></i> View</a>&nbsp;&nbsp;&nbsp;&nbsp;

                                                                <a href='./suprojectimgedit.php?editimg=<?php echo $imid; ?>' name='editimg' class='btn btn-sm bg-gradient-success'><i class='fas fa-edit'></i> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
