...
<head>
    ...
    <title>File & Content Management System | Edit Image Details</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-secondary">
                                ...
                                if (isset($_GET["editimg"])) {
                                    ...
                                    $query = "SELECT * FROM res_image_db WHERE imid = '$id'";
                                    $result = mysqli_query($conn, $query);
                                    if ($result) {
                                        $userData = mysqli_fetch_array($result);
                                ?>
                                        <form id="quickForm" action="suprojectimgeditdb.php" method="POST" enctype="multipart/form-data">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="exampleInputbuname">Image Title</label>
                                                            <input type="text" name="imtitle" class="form-control" id="exampleInputbuname" placeholder="Enter Title" value="<?php echo $userData['imtitle']; ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                        ...
                                                        // Check if imid is assigned to prid in res_image_db
                                                        $imid = $userData['imid'];
                                                        $imprid = $userData['prid'];
                          ...
                          <div class='col-md-12'>
                          <label for='exampleInputbuname'>Upload New Image</label>
<input type='file' class='btn btn-secondary btn' name='imcontent' id='fileToUpload' accept='image/*' capture='camera' >
                          </div>
                        </div>
                        <input type='hidden' name=oldimfilename value='" . $userData['imfilename'] . "'/>
                        <br>
                      </div>
                      <div>
                      </div>";
                                                        ...
                                                        <div style="text-align:center;">
                                                            ...
                                                            <input type="hidden" value="<?php echo $userData['imid']; ?>" name="editimg">
                                                        </div>
                                                        <!-- /.row -->
                                        </form>
