...
<head>
    ...
    <title>File & Content Management System | Project Assigned</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Project Assigned</h1>
                        </div>
                    </div>
                </div>
                <!-- /.container-fluid -->
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $buid = $_SESSION['suid'];
                                            include("connect.php");
                                            $query = "SELECT * FROM cus_assigned_users WHERE buid = $buid";
                                            $data = mysqli_query($conn, $query);
                                            $i = 0;

                                            while ($result = mysqli_fetch_array($data)) {
                                                $prid = $result['prid'];
                                                $query2 = "SELECT prname FROM res_project_db WHERE prid = $prid";
                                                $data2 = mysqli_query($conn, $query2);
                                                while ($result2 = mysqli_fetch_array($data2)) {
                                                    echo "<tr>
                                                        <td>" . ++$i . "</td>
                                                        <td>" . $result2['prname'] . "</td> 
                                                    </tr>";
                                                }
                                            }
                                            ?>
