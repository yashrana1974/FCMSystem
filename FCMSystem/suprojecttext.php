                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>&nbsp;</div>
                            <div>
                                &nbsp;&nbsp;<a href="suprojecttextadd.php" class="btn btn- bg-gradient-primary"><i class="fas fa-sticky-note"></i> Add Text Message</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td class='truncate' title='<?php echo htmlspecialchars($textresult['txcontent']); ?>'><?php echo substr(htmlspecialchars($textresult['txcontent']), 0, 100); ?></td>
                                                        <td>
                                                            
                                                            <a href='./suprojecttextview.php?viewtext=<?php echo $txid; ?>' name='viewproject' class='btn btn-sm bg-gradient-info'><i class='fas fa-pencil-alt'></i> View</a>&nbsp;&nbsp;&nbsp;&nbsp;

                                                            <a href='./suprojecttextedit.php?edittext=<?php echo $txid; ?>' name='editproject' class='btn btn-sm bg-gradient-success'><i class='fas fa-edit'></i> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
