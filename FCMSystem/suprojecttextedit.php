...
<head>
  ...
  <title>File & Content Management System | Edit Text Message Details</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Edit Text Message</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-secondary">
                ...
                if (isset($_GET["edittext"])) {
                  ...
                  $query = "SELECT * FROM res_text_db WHERE txid = '$id'";
                  $result = mysqli_query($conn, $query);
                  if ($result) {
                    $userData = mysqli_fetch_array($result);
                ?>
                    <form id="quickForm" action="suprojecttexteditdb.php" method="POST">
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="exampleInputbuname">Text Title</label>
                              <input type="text" name="txtitle" class="form-control" id="exampleInputbuname" placeholder="Enter Title" value="<?php echo $userData['txtitle']; ?>" required>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                            ...
                            <textarea type="text" class="form-control" id="exampleInputbuname" placeholder="Enter Content" name="txcontent" rows="8" required><?php echo $userData['txcontent']; ?></textarea>
                          </div>
                        </div><br>
                      </div>
                      <div>
              ...
              <div style="text-align:center;">
                ...
                <input type="hidden" value="<?php echo $userData['txid']; ?>" name="edittext">
              </div>
              <!-- /.row -->
              </form>
