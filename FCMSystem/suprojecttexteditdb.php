...
if (isset($_POST['edittext'])) {
    ...
    $query = "UPDATE res_text_db SET prid = '$prid', txtitle = '$txtitle', txcontent = '$txcontent' WHERE txid = '$id'";
    $data = mysqli_query($conn, $query);

    if ($data) {
        header("Location: http://localhost/fCMS/FCMSystem/suprojecttext.php");
    } else {
