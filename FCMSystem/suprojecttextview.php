...
<head>
    ...
    <title>File & Content Management System | View Text Message Details</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">View Text</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="./suprojecttext.php">
                                        <h5><u>
                                                << Back</u>
                                        </h5>
                                    </a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-secondary">
                                ...
                                $buid = $_SESSION['suid'];
                                include("connect.php");
                                if (isset($_GET["viewtext"])) {
                                    $id = $_GET["viewtext"];
                                    // Fetch data from the database based on the user ID
                                    $viewTextQuery = "SELECT * FROM res_text_db WHERE txid = '$id'";
                                    $result = mysqli_query($conn, $viewTextQuery);
                                    if ($result) {
                                ...
                                <div class='row'>
                                  <div class='col-md-6'>
                                    <div class='form-group'>
                                      <label for='exampleInputbuname'>Text Title</label>
                                      <input type='text' name='txtitle' class='form-control' id='exampleInputbuname' placeholder='Enter Title' value='" . $userData['txtitle'] . "' readonly>
                                    </div>
                                  </div>
                                  <div class='col-md-12'>
                                    <label>Select Project</label><br>
                                    <select class='form-control' name='txprid' readonly>";
                                        // Remaining code for select options
                                        $selectProjectQuery = "SELECT prid, prname FROM res_project_db WHERE buid = '$buid'";
                                        $data = mysqli_query($conn, $selectProjectQuery);

                                        // Check if txid is assigned to prid in res_text_db
                                        $txid = $userData['txid'];
                                        $txprid = $userData['prid'];
                                        $assignedPridQuery = "SELECT prid, prname FROM res_project_db WHERE prid = '$txprid'";
                                  ...
                                  <div class='col-md-12'>
                                  <br>
                                    <label for='exampleInputbuname'>Text Content</label>
                                    <textarea type='text' class='form-control' id='exampleInputbuname' placeholder='Enter Content' name='txcontent' rows='8' readonly>" . $userData['txcontent'] . "</textarea>
                                  </div>
                                </div><br>
                              </div>
                              <div>
