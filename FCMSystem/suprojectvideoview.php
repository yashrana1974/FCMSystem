                                ...
                                <div class='row'>
                                  <div class='col-md-6'>
                                    <div class='form-group'>
                                      ...
                                      <input type='video' name='vititle' class='form-control' id='exampleInputbuname' placeholder='Enter Title' value='" . $userData['vititle'] . "' readonly>
                                    </div>
                                  </div>
                                  <div class='col-md-12'>
                                  ...
                                  <source src='./Videos/" . $userData['vifilename'] . "' type='video/mp4'>
                                  </video>
                                  </div>
                                </div><br>
                              </div>
